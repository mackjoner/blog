...
<header class="am-topbar am-topbar-inverse navbar">
  ...
  <h1 class="am-topbar-brand">
    <a href="https://github.com/mackjoner" target="_blank" class="am-text-ir"><img class="head-pic" src="<?php $this->options->themeUrl('img/GitHub-Mark-Light-32px.png') ?>" alt="<?php $this->options->title() ?>" /></a>
  </h1>
