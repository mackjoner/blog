...
<footer id="footer" role="contentinfo" class="footer">
    &copy; <?php echo date('Y'); ?> <a href="<?php $this->options->siteUrl(); ?>"><?php $this->options->title(); ?></a>  ·  Blog by『<a href="http://typecho.org/" target="_blank">Typecho</a>』&『<a href="https://github.com/nodejh/typecho-theme-bing" target="_blank">typecho-theme-bing</a>』
</footer><!-- end #footer -->
